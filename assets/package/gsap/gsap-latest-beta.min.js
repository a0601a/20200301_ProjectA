...
!function(t, e) {
  ...
  function Sa(e) {
      ...
      return function(t) {
          return ~~(Math.round(parseFloat(t) / e) * e * r) / r + (p(t) ? 0 : Ka(t))
      }
  }
  function Ta(u, t) {
      var h, l, e = W(u);
  ...
  function Ua(t, e, r, i) {
      return Ia(W(t) ? !e : !0 === r ? !!(r = 0) : !i, function() {
          return W(t) ? t[~~(Math.random() * t.length)] : (r = r || 1e-5) && (i = r < 1 ? Math.pow(10, (r + "").length - 2) : 1) && ~~(Math.round((t + Math.random() * (e - t)) / r) * r * i) / i
      })
  }
  function Ya(e, r, t) {
      ...
      t.totalDuration = function totalDuration(t) {
          ...
          if (s._dirty) {
              for (n = s.parent; o; )
                  ...
                  a < (r = xa(o)) && o._ts && (a = r),
                  o = e;
              Ea(s, s === F && s._time > a ? s._time : Math.min(E, a), 1),
              s._dirty = 0
          }
          return s._tDur
      }
  ...
  var It, Lt = function _addPropTween(t, e, r, i, a, s, u, h, l) {
      ...
      !E) {
          ...
          g) {
              ...
              qa(t._startAt = Ht.set(S, pt(la(_, st), {
                  overwrite: !1,
                  data: "isFromStart",
                  lazy: v && s(y),
                  immediateRender: v,
  ...
  }, Nt = ct + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase", Ut = (Nt + ",id,stagger,delay,duration,paused").split(","), Ht = function(D) {
      function Tween(t, e, i, n) {
          ...
          (T || !v && !x && a._start === S._time && s(T) && function _hasNoPausedAncestors(t) {
      ...
      return t.render = function render(t, e, r) {
          ...
          if (p) {
              ...
              !function _renderZeroDurationTween(t, e, r, i) {
                  ...
                  (t._initted || !Ba(t, e, i, r)) && (s !== a || i || t._zTime === B || !e && t._zTime)) {
  ...
  Ht.version = Bt.version = ie.version = "3.3.0",
  f = 1,
  t() && Ct();
  function Tc(t, e) {
